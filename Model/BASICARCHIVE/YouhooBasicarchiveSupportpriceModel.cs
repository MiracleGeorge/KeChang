...
{
	/// <summary>
	/// 实体类：YouhooBasicarchiveSupportpriceModel (属性说明自动提取数据库字段的描述信息)
	/// 时间：2017/4/5 12:59:39
	/// </summary>
	[Serializable]
	public class YouhooBasicarchiveSupportpriceModel
	{
		public YouhooBasicarchiveSupportpriceModel()
		{
			_id = 0;
		}
		...
		public YouhooBasicarchiveSupportpriceModel(DataRow dr)
		{
