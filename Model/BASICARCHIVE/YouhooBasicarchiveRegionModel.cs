...
{
	/// <summary>
	/// 实体类：YouhooBasicarchiveRegionModel (属性说明自动提取数据库字段的描述信息)
	/// 时间：2017/4/5 12:59:38
	/// </summary>
	[Serializable]
	public class YouhooBasicarchiveRegionModel
	{
		public YouhooBasicarchiveRegionModel()
		{
			_id = 0;
		}
		...
		public YouhooBasicarchiveRegionModel(DataRow dr)
		{
