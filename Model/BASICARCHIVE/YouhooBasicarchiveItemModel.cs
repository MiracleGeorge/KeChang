...
{
	/// <summary>
	/// 实体类：YouhooBasicarchiveItemModel (属性说明自动提取数据库字段的描述信息)
	/// 时间：2017/4/5 12:59:38
	/// </summary>
	[Serializable]
	public class YouhooBasicarchiveItemModel
	{
		public YouhooBasicarchiveItemModel()
		{
			_id = 0;
		}
		...
		public YouhooBasicarchiveItemModel(DataRow dr)
		{
