...
{
	/// <summary>
	/// 实体类：YouhooRebateSaleModel (属性说明自动提取数据库字段的描述信息)
	/// 时间：2017/4/4 19:39:06
	/// </summary>
	[Serializable]
	public class YouhooRebateSaleModel
	{
		public YouhooRebateSaleModel()
		{
			_Rebate_id = 0;
		}

		#region Model
		private int _Rebate_id;
		...
		public YouhooRebateSaleModel(DataRow dr)
		{
			if (dr["Rebate_id"] != null && dr["Rebate_id"].ToString().Trim() != "") _Rebate_id = Int32.Parse(dr["Rebate_id"].ToString().Trim());
		...
		public int RebateId
		{
			set{ _Rebate_id=value;}
			get{return _Rebate_id;}
		}
		/// <summary>
		/// 名称
		/// </summary>
