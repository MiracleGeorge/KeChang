...
{
	/// <summary>
	/// 实体类：YouhooRebateRebatewayModel (属性说明自动提取数据库字段的描述信息)
	/// 时间：2017/4/5 15:34:11
	/// </summary>
	[Serializable]
	public class YouhooRebateRebatewayModel
	{
		public YouhooRebateRebatewayModel()
		{
			_id = 0;
		}
		...
		public YouhooRebateRebatewayModel(DataRow dr)
		{
			if (dr["id"] != null && dr["id"].ToString().Trim() != "") _id = Int32.Parse(dr["id"].ToString().Trim());
			if (dr["rebate_type"] != null) _rebate_type = dr["rebate_type"].ToString().Trim();
		...
		{
			set{ _rebate_type=value;}
			get{return _rebate_type;}
		}
		/// <summary>
		/// 返利方式名称
		/// </summary>
