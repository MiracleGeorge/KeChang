...
{
	/// <summary>
	/// 实体类：YouhooBasicarchiveBrandModel (属性说明自动提取数据库字段的描述信息)
	/// 时间：2017/4/5 12:59:37
	/// </summary>
	[Serializable]
	public class YouhooBasicarchiveBrandModel
	{
		public YouhooBasicarchiveBrandModel()
		{
			_id = 0;
		}
		...
		public YouhooBasicarchiveBrandModel(DataRow dr)
		{
