...
{
	/// <summary>
	/// 实体类：YouhooBasicarchiveChannelModel (属性说明自动提取数据库字段的描述信息)
	/// 时间：2017/4/5 12:59:38
	/// </summary>
	[Serializable]
	public class YouhooBasicarchiveChannelModel
	{
		public YouhooBasicarchiveChannelModel()
		{
			_id = 0;
		}
		...
		public YouhooBasicarchiveChannelModel(DataRow dr)
		{
