...
{
	/// <summary>
	/// 实体类：YouhooBasicarchiveTownModel (属性说明自动提取数据库字段的描述信息)
	/// 时间：2017/5/3 16:04:42
	/// </summary>
	[Serializable]
	public class YouhooBasicarchiveTownModel
	{
		public YouhooBasicarchiveTownModel()
		{
			_id = 0;
		}
		...
		public YouhooBasicarchiveTownModel(DataRow dr)
		{
