...
{
	/// <summary>
	/// 实体类：YouhooBasicarchivePriceModel (属性说明自动提取数据库字段的描述信息)
	/// 时间：2017/4/5 12:59:38
	/// </summary>
	[Serializable]
	public class YouhooBasicarchivePriceModel
	{
		public YouhooBasicarchivePriceModel()
		{
			_id = 0;
		}
		...
		public YouhooBasicarchivePriceModel(DataRow dr)
		{
