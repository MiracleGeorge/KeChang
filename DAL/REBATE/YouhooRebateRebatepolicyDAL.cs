			...
			try
			{
				using (DBSqlServer db = new DBSqlServer())
				{
					...
					SqlParameter[] parameters = {
						...
						db.MakeInParam("@brand_id", SqlDbType.Int,4,model.BrandId),
						db.MakeInParam("@channel_id", SqlDbType.Int,4,model.ChannelId),
						db.MakeInParam("@item_id", SqlDbType.Int,4,model.ItemId),
						db.MakeInParam("@price_id", SqlDbType.Int,4,model.PriceId),
						db.MakeInParam("@region_id", SqlDbType.Int,4,model.RegionId),
						db.MakeInParam("@sort_id_id", SqlDbType.Int,4,model.SortIdId),
						db.MakeInParam("@SupportWay_id", SqlDbType.Int,4,model.SupportwayId),
						db.MakeInParam("@SupportPrice_id", SqlDbType.Int,4,model.SupportpriceId),
						db.MakeInParam("@RebateType_id", SqlDbType.Int,4,model.RebatetypeId),
						db.MakeInParam("@time_id", SqlDbType.Int,4,model.TimeId),
