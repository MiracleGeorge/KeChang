...
{
	/// <summary>
	/// 业务逻辑类：YouhooBasicarchiveTownBLL
	/// 时间：2017/5/3 15:49:25
	/// </summary>
	public class YouhooBasicarchiveTownBLL
	{
		private readonly YouhooBasicarchiveTownDAL dal=new YouhooBasicarchiveTownDAL();
		public static string CacheName = "YouhooBasicarchiveTownDAL-";

		public YouhooBasicarchiveTownBLL()
		{}
		#region  成员方法
		/// <summary>
		/// 是否存在该记录
		...
		public YouhooBasicarchiveTownModel GetModel(int id)
		{
			...
			YouhooBasicarchiveTownModel model = CacheHelper.GetCache(strCache) as YouhooBasicarchiveTownModel;
			if (model == null)
			{
