...
{
	/// <summary>
	/// 业务逻辑类：YouhooBasicarchiveItemBLL
	/// 时间：2017/4/5 12:59:38
	/// </summary>
	public class YouhooBasicarchiveItemBLL
	{
		private readonly YouhooBasicarchiveItemDAL dal=new YouhooBasicarchiveItemDAL();
		public static string CacheName = "YouhooBasicarchiveItemDAL-";

		public YouhooBasicarchiveItemBLL()
		{}
		#region  成员方法
		/// <summary>
		/// 是否存在该记录
		...
		public YouhooBasicarchiveItemModel GetModel(int id)
		{
			...
			YouhooBasicarchiveItemModel model = CacheHelper.GetCache(strCache) as YouhooBasicarchiveItemModel;
			if (model == null)
			{
