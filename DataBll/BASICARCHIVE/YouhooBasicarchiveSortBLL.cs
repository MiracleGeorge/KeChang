...
{
	/// <summary>
	/// 业务逻辑类：YouhooBasicarchiveSortBLL
	/// 时间：2017/4/5 12:59:39
	/// </summary>
	public class YouhooBasicarchiveSortBLL
	{
		private readonly YouhooBasicarchiveSortDAL dal=new YouhooBasicarchiveSortDAL();
		public static string CacheName = "YouhooBasicarchiveSortDAL-";

		public YouhooBasicarchiveSortBLL()
		{}
		#region  成员方法
		/// <summary>
		/// 是否存在该记录
		...
		public YouhooBasicarchiveSortModel GetModel(int id)
		{
			...
			YouhooBasicarchiveSortModel model = CacheHelper.GetCache(strCache) as YouhooBasicarchiveSortModel;
			if (model == null)
			{
