...
{
	/// <summary>
	/// 业务逻辑类：YouhooBasicarchiveSupportpriceBLL
	/// 时间：2017/4/5 12:59:39
	/// </summary>
	public class YouhooBasicarchiveSupportpriceBLL
	{
		private readonly YouhooBasicarchiveSupportpriceDAL dal=new YouhooBasicarchiveSupportpriceDAL();
		public static string CacheName = "YouhooBasicarchiveSupportpriceDAL-";

		public YouhooBasicarchiveSupportpriceBLL()
		{}
		#region  成员方法
		/// <summary>
		/// 是否存在该记录
		...
		public YouhooBasicarchiveSupportpriceModel GetModel(int id)
		{
			...
			YouhooBasicarchiveSupportpriceModel model = CacheHelper.GetCache(strCache) as YouhooBasicarchiveSupportpriceModel;
			if (model == null)
			{
