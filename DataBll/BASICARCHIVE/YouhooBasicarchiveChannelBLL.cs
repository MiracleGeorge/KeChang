...
{
	/// <summary>
	/// 业务逻辑类：YouhooBasicarchiveChannelBLL
	/// 时间：2017/4/5 12:59:38
	/// </summary>
	public class YouhooBasicarchiveChannelBLL
	{
		private readonly YouhooBasicarchiveChannelDAL dal=new YouhooBasicarchiveChannelDAL();
		public static string CacheName = "YouhooBasicarchiveChannelDAL-";

		public YouhooBasicarchiveChannelBLL()
		{}
		#region  成员方法
		/// <summary>
		/// 是否存在该记录
		...
		public YouhooBasicarchiveChannelModel GetModel(int id)
		{
			...
			YouhooBasicarchiveChannelModel model = CacheHelper.GetCache(strCache) as YouhooBasicarchiveChannelModel;
			if (model == null)
			{
