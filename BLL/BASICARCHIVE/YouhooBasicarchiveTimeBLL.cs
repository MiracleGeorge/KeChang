...
{
	/// <summary>
	/// 业务逻辑类：YouhooBasicarchiveTimeBLL
	/// 时间：2017/4/5 12:59:39
	/// </summary>
	public class YouhooBasicarchiveTimeBLL
	{
		private readonly YouhooBasicarchiveTimeDAL dal=new YouhooBasicarchiveTimeDAL();
		public static string CacheName = "YouhooBasicarchiveTimeDAL-";

		public YouhooBasicarchiveTimeBLL()
		{}
		#region  成员方法
		/// <summary>
		/// 是否存在该记录
		...
		public YouhooBasicarchiveTimeModel GetModel(int id)
		{
			...
			YouhooBasicarchiveTimeModel model = CacheHelper.GetCache(strCache) as YouhooBasicarchiveTimeModel;
			if (model == null)
			{
