...
{
	/// <summary>
	/// 业务逻辑类：YouhooBasicarchiveBrandBLL
	/// 时间：2017/4/5 12:59:37
	/// </summary>
	public class YouhooBasicarchiveBrandBLL
	{
		private readonly YouhooBasicarchiveBrandDAL dal=new YouhooBasicarchiveBrandDAL();
		public static string CacheName = "YouhooBasicarchiveBrandDAL-";

		public YouhooBasicarchiveBrandBLL()
		{}
		#region  成员方法
		/// <summary>
		/// 是否存在该记录
		...
		public YouhooBasicarchiveBrandModel GetModel(int id)
		{
			...
			YouhooBasicarchiveBrandModel model = CacheHelper.GetCache(strCache) as YouhooBasicarchiveBrandModel;
			if (model == null)
			{
