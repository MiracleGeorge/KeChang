...
{
	/// <summary>
	/// 业务逻辑类：YouhooBasicarchiveRegionBLL
	/// 时间：2017/4/5 12:59:38
	/// </summary>
	public class YouhooBasicarchiveRegionBLL
	{
		private readonly YouhooBasicarchiveRegionDAL dal=new YouhooBasicarchiveRegionDAL();
		public static string CacheName = "YouhooBasicarchiveRegionDAL-";

		public YouhooBasicarchiveRegionBLL()
		{}
		#region  成员方法
		/// <summary>
		/// 是否存在该记录
		...
		public YouhooBasicarchiveRegionModel GetModel(int id)
		{
			...
			YouhooBasicarchiveRegionModel model = CacheHelper.GetCache(strCache) as YouhooBasicarchiveRegionModel;
			if (model == null)
			{
