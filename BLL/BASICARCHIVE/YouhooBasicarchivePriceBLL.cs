...
{
	/// <summary>
	/// 业务逻辑类：YouhooBasicarchivePriceBLL
	/// 时间：2017/4/5 12:59:38
	/// </summary>
	public class YouhooBasicarchivePriceBLL
	{
		private readonly YouhooBasicarchivePriceDAL dal=new YouhooBasicarchivePriceDAL();
		public static string CacheName = "YouhooBasicarchivePriceDAL-";

		public YouhooBasicarchivePriceBLL()
		{}
		#region  成员方法
		/// <summary>
		/// 是否存在该记录
		...
		public YouhooBasicarchivePriceModel GetModel(int id)
		{
			...
			YouhooBasicarchivePriceModel model = CacheHelper.GetCache(strCache) as YouhooBasicarchivePriceModel;
			if (model == null)
			{
