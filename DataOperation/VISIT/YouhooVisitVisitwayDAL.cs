...
{
	/// <summary>
	/// 数据访问类：YouhooVisitVisitwayDAL
	/// 时间：2017/4/24 15:13:19
	/// </summary>
		...
		public bool Exists(int visitWayId)
		{
			try
			{
				using (DBSqlServer db = new DBSqlServer())
				{
					...
					//记录操作日志
					Logger.Debug(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ",输入参数：exec sp_youhoo_Visit_VisitWay_exists " + _p);
			...
			{
				//记录错误日志
				Logger.Error(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ", 错误原因：" + ex.Message + ", 输入参数：exec sp_youhoo_Visit_VisitWay_exists " + _p);
				throw ex;
			}
		}
		...
		public int InsertUpdate(YouhooVisitVisitwayModel model, int operatorId)
		{
			try
			{
				using (DBSqlServer db = new DBSqlServer())
				{
					...
					//记录操作日志
					Logger.Debug(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ",输入参数：exec sp_youhoo_Visit_VisitWay_insertupdate " + _p);
			...
			{
				//记录错误日志
				Logger.Error(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ", 错误原因：" + ex.Message + ", 输入参数：exec sp_youhoo_Visit_VisitWay_insertupdate " + _p);
				throw ex;
			}
		}
		...
		public int Delete(string arrayId, int operatorId)
		{
			try
			{
				using (DBSqlServer db = new DBSqlServer())
				{
					...
					//记录操作日志
					Logger.Debug(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ",输入参数：exec sp_youhoo_Visit_VisitWay_delete " + _p);
			...
			{
				//记录错误日志
				Logger.Error(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ", 错误原因：" + ex.Message + ", 输入参数：exec sp_youhoo_Visit_VisitWay_delete " + _p);
				throw ex;
			}
		}
		...
		public YouhooVisitVisitwayModel GetModel(int visitWayId)
		{
			try
			{
				using (DBSqlServer db = new DBSqlServer())
				{
					...
					//记录操作日志
					Logger.Debug(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ",输入参数：exec sp_youhoo_Visit_VisitWay_getmodel " + _p);
			...
			{
				//记录错误日志
				Logger.Error(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ", 错误原因：" + ex.Message + ", 输入参数：exec sp_youhoo_Visit_VisitWay_getmodel " + _p);
				throw ex;
			}
		}
		...
		public DataTable GetList(string strWhere)
		{
			try
			{
				using (DBSqlServer db = new DBSqlServer())
				{
					...
					//记录操作日志
					Logger.Debug(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ",输入参数：exec sp_youhoo_Visit_VisitWay_getlist " + _p);
			...
			{
				//记录错误日志
				Logger.Error(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ", 错误原因：" + ex.Message + ", 输入参数：exec sp_youhoo_Visit_VisitWay_getlist " + _p);
				throw ex;
			}
		}
		...
		public DataTable GetListByPage(int pageIndex, int pageSize, string strWhere, string orderBy, out int count)
		{
			try
			{
				using (DBSqlServer db = new DBSqlServer())
				{
					...
					//记录操作日志
					Logger.Debug(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ",输入参数：exec sp_youhoo_Visit_VisitWay_getlistbypage " + _p);
			...
			{
				//记录错误日志
				Logger.Error(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ", 错误原因：" + ex.Message + ", 输入参数：exec sp_youhoo_Visit_VisitWay_getlistbypage " + _p);
				throw ex;
			}
		}
		#endregion  成员方法
