...
{
	/// <summary>
	/// 数据访问类：YouhooSysStoreDAL
	/// 时间：2017-03-02 9:52:28
	/// </summary>
	public class YouhooSysStoreDAL
	{
		private string _p = "";

		public YouhooSysStoreDAL()
		{}
		#region  成员方法
		/// <summary>
		/// 是否存在该记录
		...
		public bool Exists(int Id)
		{
			try
			{
				using (DBSqlServer db = new DBSqlServer())
				{
					...
					strSql.Append("sp_youhoo_sys_store_exists");
					...
					//记录操作日志
					Logger.Debug(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ",输入参数：exec sp_youhoo_sys_store_exists " + _p);
			...
			{
				//记录错误日志
				Logger.Error(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ", 错误原因：" + ex.Message + ", 输入参数：exec sp_youhoo_sys_store_exists " + _p);
				throw ex;
			}
		}
		...
		public int InsertUpdate(YouhooSysStoreModel model, int operatorId)
		{
			try
			{
				...
				{
					StringBuilder strSql = new StringBuilder();
					strSql.Append("sp_youhoo_sys_store_insertupdate");
					SqlParameter[] parameters = {
						...
						db.MakeInParam("@PaymentTerm", SqlDbType.NVarChar,50,model.Paymentterm),
						db.MakeInParam("@Adress", SqlDbType.NVarChar,100,model.Adress),
					...
					//记录操作日志
					Logger.Debug(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ",输入参数：exec sp_youhoo_sys_store_insertupdate " + _p);
			...
			{
				//记录错误日志
				Logger.Error(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ", 错误原因：" + ex.Message + ", 输入参数：exec sp_youhoo_sys_store_insertupdate " + _p);
				throw ex;
			}
		}
		...
		public int Delete(string arrayId, int operatorId)
		{
			try
			{
				...
				{
					StringBuilder strSql = new StringBuilder();
					strSql.Append("sp_youhoo_sys_store_delete");
					SqlParameter[] parameters = {
					...
					//记录操作日志
					Logger.Debug(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ",输入参数：exec sp_youhoo_sys_store_delete " + _p);
			...
			{
				//记录错误日志
				Logger.Error(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ", 错误原因：" + ex.Message + ", 输入参数：exec sp_youhoo_sys_store_delete " + _p);
				throw ex;
			}
		}
		...
		public YouhooSysStoreModel GetModel(int Id)
		{
			try
			{
				...
				{
					StringBuilder strSql = new StringBuilder();
					strSql.Append("sp_youhoo_sys_store_getmodel");
					SqlParameter[] parameters = {
						db.MakeInParam("@Id", SqlDbType.Int,4,Id)
					};
					...
					//记录操作日志
					Logger.Debug(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ",输入参数：exec sp_youhoo_sys_store_getmodel " + _p);
					
					DataTable dt = db.Query(strSql.ToString(), CommandType.StoredProcedure, parameters);
					if (dt != null && dt.Rows.Count != 0)
						return new YouhooSysStoreModel(dt.Rows[0]);
					return null;
				}
			}
			catch (Exception ex)
			{
				//记录错误日志
				Logger.Error(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ", 错误原因：" + ex.Message + ", 输入参数：exec sp_youhoo_sys_store_getmodel " + _p);
				throw ex;
			}
		}
		...
		public DataTable GetList(string strWhere)
		{
			try
			{
				...
				{
					StringBuilder strSql = new StringBuilder();
					strSql.Append("sp_youhoo_sys_store_getlist");
					SqlParameter[] parameters = {
					...
					//记录操作日志
					Logger.Debug(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ",输入参数：exec sp_youhoo_sys_store_getlist " + _p);
			...
			{
				//记录错误日志
				Logger.Error(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ", 错误原因：" + ex.Message + ", 输入参数：exec sp_youhoo_sys_store_getlist " + _p);
				throw ex;
			}
		}
		...
		public DataTable GetListByPage(int pageIndex, int pageSize, string strWhere, string orderBy, out int count)
		{
			try
			{
				...
				{
					StringBuilder strSql = new StringBuilder();
					strSql.Append("sp_youhoo_sys_store_getlistbypage");
					SqlParameter[] parameters = {
					...
					//记录操作日志
					Logger.Debug(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ",输入参数：exec sp_youhoo_sys_store_getlistbypage " + _p);
			...
			{
				//记录错误日志
				Logger.Error(GetType().FullName + "." + MethodBase.GetCurrentMethod().Name + ", 错误原因：" + ex.Message + ", 输入参数：exec sp_youhoo_sys_store_getlistbypage " + _p);
				throw ex;
			}
		}
		#endregion  成员方法
