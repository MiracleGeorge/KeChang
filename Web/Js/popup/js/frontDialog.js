...
Dialog.prototype.create = function() {
    ...
    $(a).find("input[type='button']").each(function() {
        if (!$(this).attr("class")) {
            ...
            $(this).hover(function() {
                $(this).addClass("dialogButton_hover")
            },
            function() {
                $(this).removeClass("dialogButton_hover")
            })
        }
    });
    a = null
