...
{
	public partial class RebateRebatewayEdit : BasePage
	{
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				if (DataRequest.QueryExists("id"))
				{
					...
					//txt_rebate_type.Text = model.RebateType;
		...
		{
			YouhooRebateRebatewayModel model = new YouhooRebateRebatewayModel();
			if (DataRequest.QueryExists("id"))
			{
			...
			model.RebateType =ddl_rebateType.SelectedIndex.ToString();
