...
{
	public partial class RebateSaleList : BasePage
	{
		private readonly YouhooRebateSaleBLL bll = new YouhooRebateSaleBLL();
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				hf_returnUrl.Value = DataRequest.DESEncode(Request.RawUrl);
		...
		private void BindData()
		{
			...
			DataGrid1.Bind(bll.GetListByPage(AspNetPager1.CurrentPageIndex, AspNetPager1.PageSize, strWhere, "a.Rebate_id desc", out TotalRecord));//绑定数据
