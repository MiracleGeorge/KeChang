<%@ Page Language="C#" MasterPageFile="~/PageEdit.Master" AutoEventWireup="true" CodeFile="SysActionEdit.aspx.cs" Inherits="YouHoo.Web.SYS.SysActionEdit" Title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<table cellpadding="0" cellspacing="0" class="table table-bordered table-hover m10">
		<tr>
			...
			<td align="left">
				<asp:TextBox ID="txt_action_name" CssClass="validate[required,maxSize[400]]" runat="server"></asp:TextBox>
			</td>
		</tr>
		<tr>
			<td align="right" class="tableleft">
			...
			<td align="left">
				<asp:TextBox ID="txt_action_value" CssClass="validate[required,maxSize[50]] input_100" runat="server"></asp:TextBox>
			</td>
		</tr>
		<tr>
			<td align="right" class="tableleft">
