<%@ Page Language="C#" MasterPageFile="~/PageEdit.Master" AutoEventWireup="true" CodeFile="SysProcessEdit.aspx.cs" Inherits="YouHoo.Web.SYS.SysProcessEdit" Title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<table cellpadding="0" cellspacing="0" class="table table-bordered table-hover m10">
		...
		<tr>
			...
			<td align="left">
				<asp:TextBox ID="txt_Sort" CssClass="validate[required,custom[onlyNumber]] input_60" runat="server"></asp:TextBox>
			</td>
		</tr>
		<tr>
			<td align="right" class="tableleft">
