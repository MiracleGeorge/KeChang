<%@ Page Language="C#" MasterPageFile="~/PageEdit.Master" AutoEventWireup="true" CodeFile="SysPowergroupDetail.aspx.cs" Inherits="YouHoo.Web.SYS.SysPowergroupDetail" Title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<table cellpadding="0" cellspacing="0" class="table table-bordered table-hover m10">
		...
		<tr>
			...
			<td align="left">
				<asp:Label ID="lbl_powergroup_name" runat="server"></asp:Label>
			</td>
		</tr>
		<tr>
			<td align="right" class="tableleft">
