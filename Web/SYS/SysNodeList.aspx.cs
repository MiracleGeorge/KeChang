...
{
	public partial class SysNodeList : BasePage
	{
		private readonly YouhooSysNodeBLL bll = new YouhooSysNodeBLL();
		...
		private void BindData()
		{
			...
			{
                strWhere += " and a.NodeName like '%" + txt_KeyWords.Text.Trim() + "%'";
			}
