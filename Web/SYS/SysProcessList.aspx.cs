...
{
	public partial class SysProcessList : BasePage
	{
		private readonly YouhooSysProcessBLL bll = new YouhooSysProcessBLL();
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				btn_search.Visible = IsPowerExistence("030101");//查询按钮权限控制
				btn_add.Visible = IsPowerExistence("030102");//添加按钮权限控制
				btn_update.Visible = IsPowerExistence("030103");//修改按钮权限控制
				btn_delete.Visible = IsPowerExistence("030104");//删除按钮权限控制
				BindData();//绑定数据
			}
		}
		...
		private void BindData()
		{
			...
			{
                strWhere += " and a.Name like '%" + txt_KeyWords.Text.Trim() + "%'";
			}
