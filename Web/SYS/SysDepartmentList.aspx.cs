...
{
	public partial class SysDepartmentList : BasePage
	{
		private readonly YouhooSysDepartmentBLL bll = new YouhooSysDepartmentBLL();
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				btn_search.Visible = IsPowerExistence("020201");//查询按钮权限控制
				btn_add.Visible = IsPowerExistence("020202");//添加按钮权限控制
				btn_update.Visible = IsPowerExistence("020203");//修改按钮权限控制
				btn_delete.Visible = IsPowerExistence("020204");//删除按钮权限控制
				BindData();//绑定数据
			}
		}
		...
		private void BindData()
		{
			...
			{
                strWhere += " and (a.Code like '%" + txt_KeyWords.Text.Trim() + "%' or a.name like '%" + txt_KeyWords.Text.Trim() + "%' or a.SubCode like '%" + txt_KeyWords.Text.Trim() + "%' or a.SubName like '%" + txt_KeyWords.Text.Trim() + "%')";
			}
