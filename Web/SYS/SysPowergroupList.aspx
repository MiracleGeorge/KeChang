<%@ Page Language="C#" MasterPageFile="~/PageList.Master" AutoEventWireup="true" CodeFile="SysPowergroupList.aspx.cs" Inherits="YouHoo.Web.SYS.SysPowergroupList" Title="无标题页" %>

<%@ Register src="../Control/SYS/SysPowergroupGrid.ascx" tagname="SysPowergroupGrid" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	角色名称：<asp:TextBox ID="txt_powergroup_name" runat="server" Width="80px"></asp:TextBox>
	<asp:Button CssClass="Inputbtn" ID="btn_search" runat="server" Text="查询" OnClick="btn_search_Click" />
	<asp:Button CssClass="Inputbtn" ID="btn_add" runat="server" Text="添加" OnClientClick="return dialogAdd('/SYS/SysPowergroupEdit.aspx')" />
	<asp:Button CssClass="Inputbtn" ID="btn_update" runat="server" Text="修改" OnClientClick="return dialogUpdate('/SYS/SysPowergroupEdit.aspx', 'powergroup_id')" />
	...
	<asp:Button CssClass="Inputbtn" ID="btn_powerSet" runat="server" Text="权限设置" OnClientClick="return dialogCheckCustom('/SYS/SysPowerSet.aspx', '权限设置', 'powergroup_id', 1000, 550);" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
	<asp:HiddenField ID="hf_returnUrl" runat="server" />
    <asp:HiddenField ID="hf_pageIndex" runat="server" />
	<div class="tableMain">
		<uc1:SysPowergroupGrid ID="DataGrid1" runat="server" OnItemCommand="DataGrid1_ItemCommand" />
	</div>
	<div id="page">
		<ul>
