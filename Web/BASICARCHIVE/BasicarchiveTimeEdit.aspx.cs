...
{
	public partial class BasicarchiveTimeEdit : BasePage
	{
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				btn_save.Visible = (IsPowerExistence("020302") && !DataRequest.QueryExists("id")) || (IsPowerExistence("020303") && DataRequest.QueryExists("id"));
			}
		}
		...
		{
			YouhooBasicarchiveTimeModel model = new YouhooBasicarchiveTimeModel();
			if (DataRequest.QueryExists("id"))
			{
