...
{
	public partial class BasicarchiveSortList : BasePage
	{
		private readonly YouhooBasicarchiveSortBLL bll = new YouhooBasicarchiveSortBLL();
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				btn_search.Visible = IsPowerExistence("020501");//查询按钮权限控制
				btn_add.Visible = IsPowerExistence("020502");//添加按钮权限控制
				btn_update.Visible = IsPowerExistence("020503");//修改按钮权限控制
				btn_delete.Visible = IsPowerExistence("020504");//删除按钮权限控制
				BindData();//绑定数据
			}
		}
