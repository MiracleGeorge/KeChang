...
{
	public partial class BasicarchiveSupportwayEdit : BasePage
	{
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				btn_save.Visible = (IsPowerExistence("020802") && !DataRequest.QueryExists("id")) || (IsPowerExistence("020803") && DataRequest.QueryExists("id"));
			}
		}
		...
		{
			YouhooBasicarchiveSupportwayModel model = new YouhooBasicarchiveSupportwayModel();
			if (DataRequest.QueryExists("id"))
			{
