...
{
	public partial class BasicarchiveTimeList : BasePage
	{
		private readonly YouhooBasicarchiveTimeBLL bll = new YouhooBasicarchiveTimeBLL();
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				btn_search.Visible = IsPowerExistence("020301");//查询按钮权限控制
				btn_add.Visible = IsPowerExistence("020302");//添加按钮权限控制
				btn_update.Visible = IsPowerExistence("020303");//修改按钮权限控制
				btn_delete.Visible = IsPowerExistence("020304");//删除按钮权限控制
				BindData();//绑定数据
			}
		}
