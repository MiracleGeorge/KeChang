...
{
	public partial class BasicarchiveItemEdit : BasePage
	{
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				btn_save.Visible = (IsPowerExistence("020602") && !DataRequest.QueryExists("id")) || (IsPowerExistence("020603") && DataRequest.QueryExists("id"));
			}
		}
		...
		{
			YouhooBasicarchiveItemModel model = new YouhooBasicarchiveItemModel();
			if (DataRequest.QueryExists("id"))
			{
