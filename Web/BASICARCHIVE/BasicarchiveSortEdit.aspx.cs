...
{
	public partial class BasicarchiveSortEdit : BasePage
	{
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				btn_save.Visible = (IsPowerExistence("020502") && !DataRequest.QueryExists("id")) || (IsPowerExistence("020503") && DataRequest.QueryExists("id"));
			}
		}
		...
		{
			YouhooBasicarchiveSortModel model = new YouhooBasicarchiveSortModel();
			if (DataRequest.QueryExists("id"))
			{
