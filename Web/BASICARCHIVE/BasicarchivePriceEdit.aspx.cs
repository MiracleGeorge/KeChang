...
{
	public partial class BasicarchivePriceEdit : BasePage
	{
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				btn_save.Visible = (IsPowerExistence("020702") && !DataRequest.QueryExists("id")) || (IsPowerExistence("020703") && DataRequest.QueryExists("id"));
			}
		}
		...
		{
			YouhooBasicarchivePriceModel model = new YouhooBasicarchivePriceModel();
			if (DataRequest.QueryExists("id"))
			{
