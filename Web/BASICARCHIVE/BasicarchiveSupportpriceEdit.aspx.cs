...
{
	public partial class BasicarchiveSupportpriceEdit : BasePage
	{
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				btn_save.Visible = (IsPowerExistence("020902") && !DataRequest.QueryExists("id")) || (IsPowerExistence("020903") && DataRequest.QueryExists("id"));
			}
		}
		...
		{
			YouhooBasicarchiveSupportpriceModel model = new YouhooBasicarchiveSupportpriceModel();
			if (DataRequest.QueryExists("id"))
			{
