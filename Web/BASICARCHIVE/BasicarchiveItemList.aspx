<%@ Page Language="C#" MasterPageFile="~/PageList.Master" AutoEventWireup="true" CodeFile="BasicarchiveItemList.aspx.cs" Inherits="YouHoo.Web.BASICARCHIVE.BasicarchiveItemList" Title="无标题页" %>

<%@ Register src="../Control/BASICARCHIVE/BasicarchiveItemGrid.ascx" tagname="BasicarchiveItemGrid" tagprefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<asp:Button CssClass="Inputbtn" ID="btn_add" runat="server" Text="添加" OnClientClick="return dialogAdd('/BASICARCHIVE/BasicarchiveItemEdit.aspx')" />
	<asp:Button CssClass="Inputbtn" ID="btn_update" runat="server" Text="修改" OnClientClick="return dialogUpdate('/BASICARCHIVE/BasicarchiveItemEdit.aspx', 'id')" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
	...
	<div class="tableMain">
		<uc1:BasicarchiveItemGrid ID="DataGrid1" runat="server" OnItemCommand="DataGrid1_ItemCommand" />
	</div>
	<div id="page">
		<ul>
