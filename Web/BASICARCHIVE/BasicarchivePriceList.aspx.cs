...
{
	public partial class BasicarchivePriceList : BasePage
	{
		private readonly YouhooBasicarchivePriceBLL bll = new YouhooBasicarchivePriceBLL();
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				btn_search.Visible = IsPowerExistence("020701");//查询按钮权限控制
				btn_add.Visible = IsPowerExistence("020702");//添加按钮权限控制
				btn_update.Visible = IsPowerExistence("020703");//修改按钮权限控制
				btn_delete.Visible = IsPowerExistence("020704");//删除按钮权限控制
				BindData();//绑定数据
			}
		}
