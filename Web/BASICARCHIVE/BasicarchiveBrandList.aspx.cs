...
{
	public partial class BasicarchiveBrandList : BasePage
	{
		private readonly YouhooBasicarchiveBrandBLL bll = new YouhooBasicarchiveBrandBLL();
		...
		protected override void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				btn_search.Visible = IsPowerExistence("020401");//查询按钮权限控制
				btn_add.Visible = IsPowerExistence("020402");//添加按钮权限控制
				btn_update.Visible = IsPowerExistence("020403");//修改按钮权限控制
				btn_delete.Visible = IsPowerExistence("020404");//删除按钮权限控制
				BindData();//绑定数据
			}
		}
