<%@ Page Language="C#" MasterPageFile="~/PageList.Master" AutoEventWireup="true" CodeFile="VisitRecordList.aspx.cs" Inherits="YouHoo.Web.VISIT.VisitRecordList" Title="无标题页" %>

<%@ Register src="../Control/VISIT/VisitRecordGrid.ascx" tagname="VisitRecordGrid" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    查询客户：<asp:TextBox ID="txt_search_field" runat="server" Width="80px"></asp:TextBox>
